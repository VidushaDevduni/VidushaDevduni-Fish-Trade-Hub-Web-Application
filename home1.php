...
<?php endif; ?>
        ...
        <span class="sub-text">Where Freshness Meets Your Plate!</span>
        <span class="description-text">
            At Fish Trade Hub, we connect local fishermen with seafood lovers across Sri Lanka. Enjoy instant updates on the freshest catch,
            book your orders seamlessly online, and experience the joy of quality seafood delivered fresh from the coast.
        </span>
    </h1>
...
<div class="box">
    <div class="icon">
        <div class="icon-box">
            <img src="image/service.jpg" class="img1">
        </div>
    </div>
    <div class="detail">
